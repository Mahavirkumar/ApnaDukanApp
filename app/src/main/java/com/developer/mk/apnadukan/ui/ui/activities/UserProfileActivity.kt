...
class UserProfileActivity : BaseActivity(), View.OnClickListener {
    ...
    // Create a global variable for uploaded image URL.
            ...
            if (requestCode == Constants.PICK_IMAGE_REQUEST_CODE) {
                if (data != null) {
                    try {
                        ...
                        //  Replace the setImageURI with glide using the function that we have created and pass the required parameters.
