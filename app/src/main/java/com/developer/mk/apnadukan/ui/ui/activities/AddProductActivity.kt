...
class AddProductActivity : BaseActivity(), View.OnClickListener {
        ...
        if (v != null) {
            when (v.id) {
                ...
                R.id.iv_add_update_product -> {
                    ...
                    ) Constants.showImageChooser(this@AddProductActivity) else ActivityCompat.requestPermissions(
                        this,
    ...
    private fun uploadProductDetails() {
        ...
        val username =
            this.getSharedPreferences(Constants.APNADUKAN_PREFERENCES, Context.MODE_PRIVATE)
